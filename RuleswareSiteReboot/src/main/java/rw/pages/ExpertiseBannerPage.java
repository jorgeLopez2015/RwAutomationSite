...
public class ExpertiseBannerPage {
	 ...
	 //Header 
	    ...
	    //Banners
	    By industries_link=By.cssSelector("a[href='https://rulesware.com/industries/']");
	    By services_link=By.cssSelector("a[href='https://rulesware.com/services/']");
