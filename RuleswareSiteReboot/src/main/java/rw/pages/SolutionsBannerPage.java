...
public class SolutionsBannerPage {
	...
	//Header 
	    ...
	    //Banners
	    By solutions_link=By.cssSelector("a[href='https://rulesware.com/pega/']");
	    By products_link=By.cssSelector("a[href='https://rulesware.com/products/']");
	    By partners_link=By.cssSelector("a[href='https://rulesware.com/partners/']");
