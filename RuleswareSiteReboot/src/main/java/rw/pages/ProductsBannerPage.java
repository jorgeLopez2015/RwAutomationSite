...
public class ProductsBannerPage {
    ...
    //Banners
    By loan_exp_link=By.cssSelector("a[href='https://rulesware.com/loanexpediter/']");
    By launchpoint_link=By.cssSelector("a[href='https://rulesware.com/loanexpediter/']");
